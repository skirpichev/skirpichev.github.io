...
BLOG_AUTHOR = "Sergey B Kirpichev"  # (translatable)
BLOG_TITLE = "Sergey Kirpichev's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://skirpichev.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://skirpichev.github.io/"
BLOG_EMAIL = "me@skirpichev.msk.ru"
BLOG_DESCRIPTION = "My blog"  # (translatable)
...
NAVIGATION_LINKS = {
    ...
    "ru": (
        ("/ru/archive.html", "Архив", "icon-archive"),
        ("/ru/categories/index.html", "Тэги", "icon-tags"),
        ("/ru/rss.xml", "RSS лента", "icon-rss"),
    ),
}
